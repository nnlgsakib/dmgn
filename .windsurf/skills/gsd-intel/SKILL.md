...
Intel system is disabled. To activate:
  ...
  node D:/projects/go/research26/DMGN/.windsurf/get-shit-done/bin/gsd-tools.cjs config-set intel.enabled true
...
```bash
node D:/projects/go/research26/DMGN/.windsurf/get-shit-done/bin/gsd-tools.cjs intel query <term>
```
...
```bash
node D:/projects/go/research26/DMGN/.windsurf/get-shit-done/bin/gsd-tools.cjs intel status
```
...
```bash
node D:/projects/go/research26/DMGN/.windsurf/get-shit-done/bin/gsd-tools.cjs intel diff
```
...
Project root: ${CWD}
gsd-tools path: D:/projects/go/research26/DMGN/.windsurf/get-shit-done/bin/gsd-tools.cjs
