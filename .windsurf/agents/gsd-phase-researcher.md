...
```bash
node "D:/projects/go/research26/DMGN/.windsurf/get-shit-done/bin/gsd-tools.cjs" websearch "your query" --limit 10
```
...
@D:/projects/go/research26/DMGN/.windsurf/get-shit-done/references/thinking-models-research.md
...
```bash
node "D:/projects/go/research26/DMGN/.windsurf/get-shit-done/bin/gsd-tools.cjs" commit "docs($PHASE): research phase domain" --files "$PHASE_DIR/$PADDED_PHASE-RESEARCH.md"
```
