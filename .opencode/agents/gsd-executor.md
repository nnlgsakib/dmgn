...
@D:/projects/go/research26/DMGN/.opencode/get-shit-done/references/thinking-models-execution.md
...
**See @D:/projects/go/research26/DMGN/.opencode/get-shit-done/references/checkpoints.md**
...
```bash
node D:/projects/go/research26/DMGN/.opencode/get-shit-done/bin/gsd-tools.cjs commit-to-subrepo "{type}({phase}-{plan}): {concise task description}" --files file1 file2 ...
```
...
**Use template:** @D:/projects/go/research26/DMGN/.opencode/get-shit-done/templates/summary.md
...
node "D:/projects/go/research26/DMGN/.opencode/get-shit-done/bin/gsd-tools.cjs" roadmap update-plan-progress "${PHASE_NUMBER}"
...
```bash
node "D:/projects/go/research26/DMGN/.opencode/get-shit-done/bin/gsd-tools.cjs" state add-blocker "Blocker description"
```
</state_updates>
