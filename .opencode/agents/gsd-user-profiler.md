...
<reference>
@D:/projects/go/research26/DMGN/.opencode/get-shit-done/references/user-profiling.md
...
Read the user-profiling reference document at `D:/projects/go/research26/DMGN/.opencode/get-shit-done/references/user-profiling.md` to load:
