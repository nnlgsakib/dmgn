...
- **Global scope**: `D:/projects/go/research26/DMGN/.opencode/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `D:/projects/go/research26/DMGN/.opencode/notes/`)
...
2. Glob `D:/projects/go/research26/DMGN/.opencode/notes/*.md` (if directory exists) — global notes
...
Global (D:/projects/go/research26/DMGN/.opencode/notes/):
...
2. **No `.planning/`**: Falls back to global `D:/projects/go/research26/DMGN/.opencode/notes/` — works in any directory
